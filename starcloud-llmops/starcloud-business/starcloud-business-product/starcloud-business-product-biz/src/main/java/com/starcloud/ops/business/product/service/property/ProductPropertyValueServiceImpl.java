package com.starcloud.ops.business.product.service.property;

import cn.iocoder.yudao.framework.common.pojo.PageResult;
import com.starcloud.ops.business.product.controller.admin.property.vo.value.ProductPropertyValueCreateReqVO;
import com.starcloud.ops.business.product.controller.admin.property.vo.value.ProductPropertyValuePageReqVO;
import com.starcloud.ops.business.product.controller.admin.property.vo.value.ProductPropertyValueUpdateReqVO;
import com.starcloud.ops.business.product.convert.property.ProductPropertyValueConvert;
import com.starcloud.ops.business.product.dal.dataobject.property.ProductPropertyValueDO;
import com.starcloud.ops.business.product.dal.mysql.property.ProductPropertyValueMapper;
...
import static com.starcloud.ops.business.product.enums.ErrorCodeConstants.PROPERTY_VALUE_EXISTS;
import static com.starcloud.ops.business.product.enums.ErrorCodeConstants.PROPERTY_VALUE_NOT_EXISTS;
...
public class ProductPropertyValueServiceImpl implements ProductPropertyValueService {
    ...
    public void updatePropertyValue(ProductPropertyValueUpdateReqVO updateReqVO) {
        ...
        // 更新 sku 相关属性
        productSkuService.updateSkuPropertyValue(updateObj.getId(), updateObj.getName(),updateObj.getRemark());
    }
