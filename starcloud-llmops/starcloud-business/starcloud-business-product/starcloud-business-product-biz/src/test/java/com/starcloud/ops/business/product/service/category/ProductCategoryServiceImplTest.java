package com.starcloud.ops.business.product.service.category;
...
import com.starcloud.ops.business.product.dal.mysql.category.ProductCategoryMapper;
...
public class ProductCategoryServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateCategory_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> productCategoryService.updateCategory(reqVO), ErrorCodeConstants.CATEGORY_NOT_EXISTS);
    }
    ...
    public void testDeleteCategory_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> productCategoryService.deleteCategory(id), ErrorCodeConstants.CATEGORY_NOT_EXISTS);
    }
