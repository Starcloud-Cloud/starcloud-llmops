package com.starcloud.ops.business.product.service.brand;
...
import com.starcloud.ops.business.product.controller.admin.brand.vo.ProductBrandPageReqVO;
...
import com.starcloud.ops.business.product.dal.mysql.brand.ProductBrandMapper;
...
public class ProductBrandServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateBrand_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> brandService.updateBrand(reqVO), ErrorCodeConstants.BRAND_NOT_EXISTS);
    }
    ...
    public void testDeleteBrand_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> brandService.deleteBrand(id), ErrorCodeConstants.BRAND_NOT_EXISTS);
    }
