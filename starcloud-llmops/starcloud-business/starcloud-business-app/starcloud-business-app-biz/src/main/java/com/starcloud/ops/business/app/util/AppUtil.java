...
public class AppUtil {
    ...
    public static Integer buildWord(AppConfigDTO config) {
        ...
        List<StepDTO> collect = CollectionUtil.emptyIfNull(config.getSteps()).stream()
                .map(stepWrapper -> Optional.ofNullable(stepWrapper).map(StepWrapperDTO::getStep).orElse(null))
