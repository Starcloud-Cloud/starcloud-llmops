...
public class AppMarketException extends RuntimeException {
     ...
     * @param message 错误信息
     */
    public static AppMarketException exception(Integer code, String message) {
        AppMarketException exception = new AppMarketException();
     ...
     */
    public static AppMarketException exception(ResultCode resultCode, Object... args) {
        AppMarketException exception = new AppMarketException();
