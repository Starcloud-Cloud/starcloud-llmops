...
import com.starcloud.ops.business.app.model.coze.Message;
import lombok.Data;
 ...
 */
@Data
public class CozeChatReqVO implements java.io.Serializable {

    private static final long serialVersionUID = -5653250643396388775L;

    /**
     * 会话 ID，即会话的唯一标识。<br>
     * 会话 ID 由使用方在业务系统中自行定义、生成与维护。
     */
