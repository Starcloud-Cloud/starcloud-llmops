package com.starcloud.ops.business.app.domain.entity2;

import com.starcloud.ops.business.app.domain.entity2.config.ChatConfigEntity;
import com.starcloud.ops.business.app.domain.entity2.config.WorkflowFlowConfigEntity;
...
public class AppEntity {
     ...
     * 应用详细配置信息, 步骤，变量，场景等
     */
    private WorkflowFlowConfigEntity workflowFlowConfig;
    ...
    public void validate() {
        ...
        if (AppModelEnum.COMPLETION.name().equals(this.model)) {
            // 生成式应用，必须要有详细配置
            AppValidate.notNull(this.workflowFlowConfig, ErrorCodeConstants.APP_CONFIG_REQUIRED);
