package com.starcloud.ops.business.app.powerjob.config;
...
@ConditionalOnProperty(prefix = "powerjob", name = "enabled", havingValue = "true")
public class PowerJobAutoConfiguration {
    ...
    public PowerJobWorker initPowerJob(PowerJobProperties properties) {
         ...
         */
        PowerJobWorker ohMyWorker = new PowerJobWorker(config);
//        ohMyWorker.setConfig(config);

        log.info("initPowerJob is ok: {}", JSON.toJSONString(properties));
