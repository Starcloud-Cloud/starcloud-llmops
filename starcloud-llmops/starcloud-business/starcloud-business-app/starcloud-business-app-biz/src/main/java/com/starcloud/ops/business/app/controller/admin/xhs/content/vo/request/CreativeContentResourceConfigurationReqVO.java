 ...
 */
@Data
@Schema(description = "创作内容资料配置请求VO")
public class CreativeContentResourceConfigurationReqVO implements Serializable {

    private static final long serialVersionUID = -1853521116836848876L;
