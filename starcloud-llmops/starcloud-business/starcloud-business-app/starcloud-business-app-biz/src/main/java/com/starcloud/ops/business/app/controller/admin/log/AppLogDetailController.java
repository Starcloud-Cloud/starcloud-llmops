...
public class AppLogDetailController {
    ...
    public CommonResult<List<AppLogMessageRespVO>> appLogMessageDetail(@Parameter(name = "conversationUid", description = "日志会话 UID")
                                                                       @NotBlank(message = "会话ID不能为空")
                                                                       @PathVariable("conversationUid") String conversationUid) {
        return CommonResult.success(appLogService.getLogAppMessageDetail(conversationUid));
