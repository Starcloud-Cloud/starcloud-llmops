...
import com.starcloud.ops.business.app.feign.intercepter.CodeFeignConfiguration;
...
@FeignClient(name = "${feign.remote.coze.name:coze-public}",
        url = "${feign.remote.coze.url:https://api.coze.cn}", configuration = {CodeFeignConfiguration.class})
