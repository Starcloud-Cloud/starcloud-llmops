...
public enum MaterialTypeEnum implements IntArrayValuable {
    ...
    public static final int[] ARRAYS = Arrays.stream(values()).mapToInt(MaterialTypeEnum::getCode).toArray();
     ...
     * @return 是否
     */
    public static boolean isZip(Integer status) {
        return Objects.equals(status, ZIP.getCode());
    }
