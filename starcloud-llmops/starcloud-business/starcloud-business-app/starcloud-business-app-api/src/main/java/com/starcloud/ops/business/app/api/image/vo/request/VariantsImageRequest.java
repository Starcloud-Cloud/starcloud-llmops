...
@Schema(name = "VariantsImageRequest", description = "图片裂变请求")
public class VariantsImageRequest extends BaseImageRequest {

    private static final long serialVersionUID = -4982951303223864460L;
    ...
    @NotBlank(message = "需要进行裂变的图片不能为空！")
    ...
    @Max(value = 35, message = "cfgScale 需要小于等于 35")
    ...
    @InEnum(value = SamplerEnum.class, field = InEnum.EnumField.CODE, message = "sampler[{value}] 不支持，支持的: {values}")
    ...
    @Min(value = 10, message = "steps 扩散步骤数必须大于等于 10")
    @Max(value = 150, message = "steps 扩散步骤数必须小于等于 150")
