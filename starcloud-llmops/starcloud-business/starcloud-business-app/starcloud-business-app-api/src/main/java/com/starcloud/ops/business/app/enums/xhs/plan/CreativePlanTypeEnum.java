 ...
 */
@Getter
public enum CreativePlanTypeEnum implements IEnumable<Integer> {
    ...
    CreativePlanTypeEnum(Integer code, String label, AppMarketTagTypeEnum tagType) {
        this.code = code;
        this.label = label;
     ...
     * @return 枚举
     */
    public static CreativePlanTypeEnum of(String name) {
        for (CreativePlanTypeEnum item : values()) {
