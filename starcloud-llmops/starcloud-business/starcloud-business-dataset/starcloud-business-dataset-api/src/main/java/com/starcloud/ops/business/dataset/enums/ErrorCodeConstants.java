...
public interface ErrorCodeConstants {
    ...
    ErrorCode DATASET_SOURCE_UPLOAD_DATA_FAIL_APPID = new ErrorCode(2003001006, "上传数据异常，应用 ID 为空");
    ErrorCode DATASET_SOURCE_DATA_ENABLE_STATUS_FAIL = new ErrorCode(2007002007, "数据状态已经刷新,请刷新后重试");


    ErrorCode DATASET_SOURCE_DELETE_FAIL = new ErrorCode(2003001008, "删除文档失败，请等待数据学习结束后操作");
    ErrorCode SUMMARY_ERROR = new ErrorCode(2003001011, "总结文档失败");
