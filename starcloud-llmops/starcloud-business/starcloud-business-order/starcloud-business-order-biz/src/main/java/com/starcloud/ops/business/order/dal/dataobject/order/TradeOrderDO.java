package com.starcloud.ops.business.order.dal.dataobject.order;
...
import com.starcloud.ops.business.order.enums.order.TradeOrderCancelTypeEnum;
...
public class TradeOrderDO extends BaseDO {
     ...
     * 推广人编号
     *
     * 关联 { BrokerageUserDO#getId()} 字段，即 { MemberUserRespDTO#getId()} 字段
     */
