package com.starcloud.ops.business.order.framework.delivery.core.client.impl.kd100;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.HexUtil;
import cn.hutool.crypto.digest.DigestUtil;
import cn.iocoder.yudao.framework.common.util.json.JsonUtils;
import com.starcloud.ops.business.order.framework.delivery.config.TradeExpressProperties;
import com.starcloud.ops.business.order.framework.delivery.core.client.ExpressClient;
import com.starcloud.ops.business.order.framework.delivery.core.client.convert.ExpressQueryConvert;
...
import com.starcloud.ops.business.order.framework.delivery.core.client.dto.kd100.Kd100ExpressQueryReqDTO;
import com.starcloud.ops.business.order.framework.delivery.core.client.dto.kd100.Kd100ExpressQueryRespDTO;
...
import static com.starcloud.ops.business.order.enums.ErrorCodeConstants.EXPRESS_API_QUERY_ERROR;
import static com.starcloud.ops.business.order.enums.ErrorCodeConstants.EXPRESS_API_QUERY_FAILED;
...
public class Kd100ExpressClient implements ExpressClient {
    ...
    public List<ExpressTrackRespDTO> getExpressTrackList(ExpressTrackQueryReqDTO reqDTO) {
        // 发起请求
        Kd100ExpressQueryReqDTO requestDTO = ExpressQueryConvert.INSTANCE.convert2(reqDTO)
        ...
        return ExpressQueryConvert.INSTANCE.convertList2(respDTO.getTracks());
    }
