...
public interface TradeSignUpdateService {
     ...
     * @return 订单结算结果
     */
    AppTradeOrderSettlementRespVO settlementOrder(Long userId, AppTradeSignSettlementReqVO settlementReqVO);
     ...
     * @return 交易订单的
     */
    TradeOrderDO createSign(Long userId, String userIp, AppTradeSignCreateReqVO createReqVO, Integer terminal);
