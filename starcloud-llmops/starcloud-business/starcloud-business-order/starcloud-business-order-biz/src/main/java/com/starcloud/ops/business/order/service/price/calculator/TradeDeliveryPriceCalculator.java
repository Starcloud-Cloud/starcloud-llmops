...
import com.starcloud.ops.business.order.enums.delivery.DeliveryExpressChargeModeEnum;
...
import com.starcloud.ops.business.order.service.delivery.DeliveryExpressTemplateService;
import com.starcloud.ops.business.order.service.delivery.DeliveryPickUpStoreService;
...
import com.starcloud.ops.business.order.service.price.bo.TradePriceCalculateRespBO.OrderItem;
...
import static com.starcloud.ops.business.order.enums.ErrorCodeConstants.PICK_UP_STORE_NOT_EXISTS;
...
//                deliveryExpressTemplateService.getExpressTemplateMapByIdsAndArea(deliveryTemplateIds, null);
//        // 2.2 计算配送费用
...
//        calculateDeliveryPrice(selectedItem, expressTemplateMap, result);
     ...
     */
    private boolean isExpressTemplateFree(List<TradePriceCalculateRespBO.OrderItem> orderItems, Integer chargeMode,
