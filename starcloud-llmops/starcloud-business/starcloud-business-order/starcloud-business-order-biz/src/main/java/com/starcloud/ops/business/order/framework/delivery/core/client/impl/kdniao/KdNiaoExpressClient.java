package com.starcloud.ops.business.order.framework.delivery.core.client.impl.kdniao;
...
import com.starcloud.ops.business.order.framework.delivery.core.client.dto.kdniao.KdNiaoExpressQueryReqDTO;
import com.starcloud.ops.business.order.framework.delivery.core.client.dto.kdniao.KdNiaoExpressQueryRespDTO;
...
public class KdNiaoExpressClient implements ExpressClient {
    ...
    public List<ExpressTrackRespDTO> getExpressTrackList(ExpressTrackQueryReqDTO reqDTO) {
        // 发起请求
        KdNiaoExpressQueryReqDTO requestDTO = ExpressQueryConvert.INSTANCE.convert(reqDTO)
