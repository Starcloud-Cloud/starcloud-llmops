...
public enum AdminUserRightsBizTypeEnum implements IntArrayValuable {
    ...
    USER_INVITE(4, "用户推广", "用户推广获得 {} 魔法豆，{} 图片", true, true, 5, 2),
    USER_INVITE_REPEAT(5, "邀请达人", "邀请达标获得 {} 魔法豆，{} 图片", true, true, 5, 2),
    ...
    REGISTER_RECORD(52, "普通注册", "普通注册获得{},{}", true, true, 10, 5),
    INVITE_TO_REGISTER_RECORD(53, "普通注册", "普通注册获得{},{}", true, true, 10, 5),
    USER_INVITE_RECORD(54, "用户推广", "用户推广获得{},{}", true, true, 5, 2),
    USER_INVITE_REPEAT_RECORD(55, "邀请达人", "邀请达标获得{},{}", true, true, 5, 2),
    ...
    // 场景
    WEB_ADMIN_SCENE_RECORD(64, "创作中心", "创作中心，扣除 {}，{} ", false, false, 0, 0),
    CHAT_TEST_SCENE_RECORD(65, "聊天调试", "聊天调试，扣除 {}，{} ", false, false, 0, 0),
    WEB_MARKET_SCENE_RECORD(66, "应用市场", "应用市场，扣除 {}，{} ", false, false, 0, 0),
    CHAT_MARKET_SCENE_RECORD(67, "员工广场", "员工广场，扣除 {}，{} ", false, false, 0, 0),
    WEB_IMAGE_SCENE_RECORD(68, "AI自由绘图", "AI自由绘图，扣除 {}，{} ", false, false, 0, 0),
    IMAGE_UPSCALING_SCENE_RECORD(69, "图片高清放大", "图片高清放大，扣除 {}，{} ", false, false, 0, 0),
    IMAGE_REMOVE_BACKGROUND_SCENE_RECORD(70, "图片去背景", "图片去背景，扣除 {}，{} ", false, false, 0, 0),
    IMAGE_REPLACE_BACKGROUND_SCENE_RECORD(71, "图片替换背景", "图片替换背景，扣除 {}，{} ", false, false, 0, 0),
    IMAGE_REMOVE_TEXT_SCENE_RECORD(72, "图片去文字", "图片去文字，扣除 {}，{} ", false, false, 0, 0),
    IMAGE_SKETCH_SCENE_RECORD(73, "草图生成图片", "草图生成图片，扣除 {}，{} ", false, false, 0, 0),
    IMAGE_VARIANTS_SCENE_RECORD(74, "图片裂变", "图片裂变，扣除 {}，{} ", false, false, 0, 0),
    OPTIMIZE_PROMPT_SCENE_RECORD(75, "优化提示词", "优化提示词，扣除 {}，{} ", false, false, 0, 0),
    LISTING_GENERATE_SCENE_RECORD(76, "Listing生成", "Listing生成，扣除 {}，{} ", false, false, 0, 0),
    XHS_WRITING_SCENE_RECORD(77, "小红书文案", "小红书文案，扣除 {}，{} ", false, false, 0, 0),
    SHARE_WEB_SCENE_RECORD(78, "页面分享", "页面分享，扣除 {}，{} ", false, false, 0, 0),
    SHARE_IFRAME_SCENE_RECORD(79, "iframe分享", "iframe分享，扣除 {}，{} ", false, false, 0, 0),
    SHARE_JS_SCENE_RECORD(80, "JS分享", "JS分享，扣除 {}，{} ", false, false, 0, 0),
    SHARE_API_SCENE_RECORD(81, "API调用", "API调用，扣除 {}，{} ", false, false, 0, 0),
    WECOM_GROUP_SCENE_RECORD(82, "企业微信群", "企业微信群，扣除 {}，{} ", false, false, 0, 0),
    MP_SCENE_RECORD(83, "微信公共号", "微信公共号，扣除 {}，{} ", false, false, 0, 0),
    ;
