...
@Getter
@AllArgsConstructor
public enum AdminUserExperienceBizTypeEnum {
    ...
    public static AdminUserExperienceBizTypeEnum getByType(Integer type) {
        return EnumUtil.getBy(AdminUserExperienceBizTypeEnum.class,
