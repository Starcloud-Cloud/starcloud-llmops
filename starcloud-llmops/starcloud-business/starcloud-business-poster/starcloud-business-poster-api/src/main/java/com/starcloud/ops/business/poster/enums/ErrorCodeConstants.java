...
public interface ErrorCodeConstants {
    ...
    ErrorCode MATERIAL_CATEGORY_NOT_EXISTS = new ErrorCode(600003001, " 当前分类不存在");
    ...
    ErrorCode POSTER_MATERIAL_NOT_EXISTS = new ErrorCode(600004001, "海报元素不存在");


    ErrorCode SPU_MATERIAL_FAIL_CATEGORY_LEVEL_ERROR = new ErrorCode(600004001, "素材分类不正确，原因：必须使用第三级的素材分类");
