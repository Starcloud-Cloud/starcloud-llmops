package com.starcloud.ops.business.promotion.service.seckill;
...
import com.starcloud.ops.business.promotion.controller.admin.seckill.vo.activity.SeckillActivityCreateReqVO;
import com.starcloud.ops.business.promotion.controller.admin.seckill.vo.activity.SeckillActivityPageReqVO;
import com.starcloud.ops.business.promotion.controller.admin.seckill.vo.activity.SeckillActivityUpdateReqVO;
import com.starcloud.ops.business.promotion.controller.admin.seckill.vo.product.SeckillProductBaseVO;
import com.starcloud.ops.business.promotion.controller.app.seckill.vo.activity.AppSeckillActivityPageReqVO;
import com.starcloud.ops.business.promotion.convert.seckill.seckillactivity.SeckillActivityConvert;
import com.starcloud.ops.business.promotion.dal.dataobject.seckill.SeckillActivityDO;
import com.starcloud.ops.business.promotion.dal.dataobject.seckill.SeckillConfigDO;
import com.starcloud.ops.business.promotion.dal.dataobject.seckill.SeckillProductDO;
import com.starcloud.ops.business.promotion.dal.mysql.seckill.seckillactivity.SeckillActivityMapper;
import com.starcloud.ops.business.promotion.dal.mysql.seckill.seckillactivity.SeckillProductMapper;
...
import static com.starcloud.ops.business.product.enums.ErrorCodeConstants.SPU_NOT_EXISTS;
    ...
    public List<SeckillActivityDO> getSeckillActivityListByConfigIdAndStatus(Long configId, Integer status) {
        return filterList(seckillActivityMapper.selectList(SeckillActivityDO::getStatus, status),
                item -> anyMatch(item.getConfigIds(), id -> ObjectUtil.equal(id, configId)) // 校验时段
                        && LocalDateTimeUtils.isBetween(item.getStartTime(), item.getEndTime())); // 追加当前日期是否处在活动日期之间的校验条件
    }
