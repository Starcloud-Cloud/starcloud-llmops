...
import com.starcloud.ops.business.trade.controller.admin.brokerage.vo.user.BrokerageUserRespVO;
import com.starcloud.ops.business.trade.controller.app.brokerage.vo.user.AppBrokerageUserChildSummaryRespVO;
import com.starcloud.ops.business.trade.controller.app.brokerage.vo.user.AppBrokerageUserMySummaryRespVO;
...
public interface BrokerageUserConvert {
    ...
    PageResult<BrokerageUserRespVO> convertPage(PageResult<BrokerageUserDO> page, Map<Long, AdminUserDO> userMap, Map<Long, Long> brokerageUserCountMap, Map<Long, UserBrokerageSummaryRespBO> userOrderSummaryMap);
    ...
    default BrokerageUserRespVO copyTo(AdminUserDO source, BrokerageUserRespVO target) {
    ...
    void copyTo(AdminUserDO from, @MappingTarget AppBrokerageUserRankByUserCountRespVO to);
    ...
    default void copyTo(List<AppBrokerageUserChildSummaryRespVO> list, Map<Long, AdminUserDO> userMap) {
