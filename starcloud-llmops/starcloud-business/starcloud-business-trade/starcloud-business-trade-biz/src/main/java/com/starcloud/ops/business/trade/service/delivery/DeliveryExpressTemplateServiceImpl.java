...
import com.starcloud.ops.business.trade.dal.dataobject.delivery.DeliveryExpressTemplateChargeDO;
import com.starcloud.ops.business.trade.dal.dataobject.delivery.DeliveryExpressTemplateDO;
import com.starcloud.ops.business.trade.dal.dataobject.delivery.DeliveryExpressTemplateFreeDO;
import com.starcloud.ops.business.trade.dal.mysql.delivery.DeliveryExpressTemplateChargeMapper;
import com.starcloud.ops.business.trade.dal.mysql.delivery.DeliveryExpressTemplateFreeMapper;
import com.starcloud.ops.business.trade.dal.mysql.delivery.DeliveryExpressTemplateMapper;
import com.starcloud.ops.business.trade.service.delivery.bo.DeliveryExpressTemplateRespBO;
import com.starcloud.ops.business.trade.controller.admin.delivery.vo.expresstemplate.*;
import com.starcloud.ops.business.trade.convert.delivery.DeliveryExpressTemplateConvert;
...
public class DeliveryExpressTemplateServiceImpl implements DeliveryExpressTemplateService {
    ...
    private void validateTemplateNameUnique(String name, Long id) {
        ...
        // 如果 id 为空
        if (id == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.EXPRESS_TEMPLATE_NAME_DUPLICATE);
        }
    ...
    private void validateDeliveryExpressTemplateExists(Long id) {
        if (expressTemplateMapper.selectById(id) == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.EXPRESS_TEMPLATE_NOT_EXISTS);
        }
    }
