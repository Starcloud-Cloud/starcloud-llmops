package com.starcloud.ops.business.trade.controller.admin.aftersale;
...
@Tag(name = "管理后台 - 售后订单")
@RestController
@RequestMapping("/llm/trade/after-sale")
@Validated
@Slf4j
public class AfterSaleController {
    ...
    public CommonResult<PageResult<AfterSaleRespPageItemVO>> getAfterSalePage(@Valid AfterSalePageReqVO pageVO) {
        ...
        // 查询会员
        Map<Long, AdminUserDO> memberUsers = adminUserService.getUserMap(
    ...
    public CommonResult<AfterSaleDetailRespVO> getOrderDetail(@RequestParam("id") Long id) {
        ...
        // 拼接数据
        AdminUserDO user = adminUserService.getUser(afterSale.getUserId());
