...
import com.starcloud.ops.business.trade.controller.admin.delivery.vo.pickup.DeliveryPickUpStoreCreateReqVO;
import com.starcloud.ops.business.trade.controller.admin.delivery.vo.pickup.DeliveryPickUpStorePageReqVO;
import com.starcloud.ops.business.trade.controller.admin.delivery.vo.pickup.DeliveryPickUpStoreUpdateReqVO;
...
import com.starcloud.ops.business.trade.dal.mysql.delivery.DeliveryPickUpStoreMapper;
...
public class DeliveryPickUpStoreServiceImpl implements DeliveryPickUpStoreService {
    ...
    private void validateDeliveryPickUpStoreExists(Long id) {
        if (deliveryPickUpStoreMapper.selectById(id) == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PICK_UP_STORE_NOT_EXISTS);
        }
    }
