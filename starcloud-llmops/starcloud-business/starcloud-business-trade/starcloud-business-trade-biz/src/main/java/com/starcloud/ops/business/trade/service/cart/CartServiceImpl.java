...
import com.starcloud.ops.business.trade.controller.app.cart.vo.*;
import com.starcloud.ops.business.trade.convert.cart.TradeCartConvert;
import com.starcloud.ops.business.trade.dal.dataobject.cart.CartDO;
import com.starcloud.ops.business.trade.dal.mysql.cart.CartMapper;
...
public class CartServiceImpl implements CartService {
    ...
    public void updateCartCount(Long userId, AppCartUpdateCountReqVO updateReqVO) {
        ...
        if (cart == null) {
            throw exception(ErrorCodeConstants.CARD_ITEM_NOT_FOUND);
        }
        // 校验商品 SKU
