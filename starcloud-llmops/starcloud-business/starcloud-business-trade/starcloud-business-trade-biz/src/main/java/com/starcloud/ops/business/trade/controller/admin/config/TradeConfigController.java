package com.starcloud.ops.business.trade.controller.admin.config;
...
import com.starcloud.ops.business.trade.convert.config.TradeConfigConvert;
...
@RestController
@RequestMapping("/llm/trade/config")
@Validated
