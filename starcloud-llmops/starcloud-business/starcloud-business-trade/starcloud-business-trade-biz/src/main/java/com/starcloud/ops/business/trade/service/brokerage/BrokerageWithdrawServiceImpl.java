...
import com.starcloud.ops.business.trade.convert.brokerage.BrokerageWithdrawConvert;
...
import com.starcloud.ops.business.trade.dal.mysql.brokerage.BrokerageWithdrawMapper;
import com.starcloud.ops.business.trade.enums.MessageTemplateConstants;
...
import com.starcloud.ops.business.trade.enums.brokerage.BrokerageWithdrawTypeEnum;
...
public class BrokerageWithdrawServiceImpl implements BrokerageWithdrawService {
    ...
    public void auditBrokerageWithdraw(Integer id, BrokerageWithdrawStatusEnum status, String auditReason) {
        ...
        if (ObjectUtil.notEqual(BrokerageWithdrawStatusEnum.AUDITING.getStatus(), withdraw.getStatus())) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.BROKERAGE_WITHDRAW_STATUS_NOT_AUDITING);
        }
    ...
    private BrokerageWithdrawDO validateBrokerageWithdrawExists(Integer id) {
        ...
        if (withdraw == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.BROKERAGE_WITHDRAW_NOT_EXISTS);
        }
        return withdraw;
    }
    ...
    TradeConfigDO validateWithdrawPrice(Integer withdrawPrice) {
        ...
        if (tradeConfig.getBrokerageWithdrawMinPrice() != null && withdrawPrice < tradeConfig.getBrokerageWithdrawMinPrice()) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.BROKERAGE_WITHDRAW_MIN_PRICE, MoneyUtils.fenToYuanStr(tradeConfig.getBrokerageWithdrawMinPrice()));
        }
        return tradeConfig;
    }
}
