...
public interface TradeSignMapper extends BaseMapperX<TradeSignDO> {
    ...
    //
    //default PageResult<TradeSignDO> selectPage(TradeOrderPageReqVO reqVO, Set<Long> userIds) {
    //    return selectPage(reqVO, new LambdaQueryWrapperX<TradeSignDO>()
    //            .likeIfPresent(TradeSignDO::getNo, reqVO.getNo())
    //            .eqIfPresent(TradeSignDO::getUserId, reqVO.getUserId())
    //            .eqIfPresent(TradeSignDO::getDeliveryType, reqVO.getDeliveryType())
    //            .inIfPresent(TradeSignDO::getUserId, userIds)
    //            .eqIfPresent(TradeSignDO::getType, reqVO.getType())
    //            .eqIfPresent(TradeSignDO::getStatus, reqVO.getStatus())
    //            .eqIfPresent(TradeSignDO::getPayChannelCode, reqVO.getPayChannelCode())
    //            .eqIfPresent(TradeSignDO::getTerminal, reqVO.getTerminal())
    //            .eqIfPresent(TradeSignDO::getLogisticsId, reqVO.getLogisticsId())
    //            .inIfPresent(TradeSignDO::getPickUpStoreId, reqVO.getPickUpStoreIds())
    //            .likeIfPresent(TradeSignDO::getPickUpVerifyCode, reqVO.getPickUpVerifyCode())
    //            .betweenIfPresent(TradeSignDO::getCreateTime, reqVO.getCreateTime())
    //            .orderByDesc(TradeSignDO::getId));
    //}
    //
