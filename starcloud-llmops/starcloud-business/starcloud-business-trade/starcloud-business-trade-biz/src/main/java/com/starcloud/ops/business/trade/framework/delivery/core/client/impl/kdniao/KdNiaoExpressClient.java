package com.starcloud.ops.business.trade.framework.delivery.core.client.impl.kdniao;
...
import com.starcloud.ops.business.trade.framework.delivery.config.TradeExpressProperties;
...
import com.starcloud.ops.business.trade.framework.delivery.core.client.dto.kdniao.KdNiaoExpressQueryReqDTO;
import com.starcloud.ops.business.trade.framework.delivery.core.client.dto.kdniao.KdNiaoExpressQueryRespDTO;
...
import static com.starcloud.ops.business.trade.framework.delivery.core.client.convert.ExpressQueryConvert.INSTANCE;
...
public class KdNiaoExpressClient implements ExpressClient {
    ...
    public List<ExpressTrackRespDTO> getExpressTrackList(ExpressTrackQueryReqDTO reqDTO) {
        ...
        if (respDTO == null || !respDTO.getSuccess()) {
            throw exception(ErrorCodeConstants.EXPRESS_API_QUERY_FAILED, respDTO == null ? "" : respDTO.getReason());
        }
    ...
    private <Req, Resp> Resp httpRequest(String url, String requestType, Req req, Class<Resp> respClass) {
        ...
        if (!responseEntity.getStatusCode().is2xxSuccessful()) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.EXPRESS_API_QUERY_ERROR);
        }
