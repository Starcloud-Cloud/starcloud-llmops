package com.starcloud.ops.business.trade.framework.delivery.core.client.impl.kd100;
...
import com.starcloud.ops.business.trade.framework.delivery.core.client.dto.kd100.Kd100ExpressQueryReqDTO;
import com.starcloud.ops.business.trade.framework.delivery.core.client.dto.kd100.Kd100ExpressQueryRespDTO;
...
public class Kd100ExpressClient implements ExpressClient {
    ...
    public List<ExpressTrackRespDTO> getExpressTrackList(ExpressTrackQueryReqDTO reqDTO) {
        ...
        if (Objects.equals("false", respDTO.getResult())) {
            throw exception(ErrorCodeConstants.EXPRESS_API_QUERY_FAILED, respDTO.getMessage());
        }
