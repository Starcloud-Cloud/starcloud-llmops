...
import com.starcloud.ops.business.trade.dal.mysql.aftersale.AfterSaleLogMapper;
...
public class AfterSaleServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateAfterSale() {
        ...
        Assertions.assertEquals(afterSale.getStatus(), AfterSaleStatusEnum.APPLY.getStatus());
        Assertions.assertEquals(afterSale.getType(), AfterSaleTypeEnum.IN_SALE.getType());
