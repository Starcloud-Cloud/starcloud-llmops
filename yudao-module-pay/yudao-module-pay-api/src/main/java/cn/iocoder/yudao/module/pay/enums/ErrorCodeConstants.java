...
public interface ErrorCodeConstants {
    ...
    // ========== 签约订单 1-007-010-001 ==========
    ErrorCode PAY_SIGN_NOT_EXISTS = new ErrorCode(1-007-010-001, "支付签约不存在");

    ErrorCode PAY_SIGN_STATUS_IS_SUCCESS = new ErrorCode(1_007_010_002, "当前签约已支付，请刷新页面");
    ErrorCode PAY_SIGN_STATUS_IS_NOT_WAITING = new ErrorCode(1_007_010_003, "支付订单不处于待支付");

    ErrorCode PAY_SIGN_IS_EXPIRED = new ErrorCode(1_007_010_003, "当前签约的支付订单已经过期");
    ErrorCode PAY_SIGN_SUBMIT_CHANNEL_ERROR = new ErrorCode(1_007_002_004, "发起支付报错，错误码：{}，错误提示：{}");
    ErrorCode PAY_SIGN_REFUND_FAIL_STATUS_ERROR = new ErrorCode(1_007_002_005, "支付订单退款失败，原因：状态不是已支付或已退款");

    // ========== ORDER 模块(拓展单) 1-007-003-000 ==========
    ErrorCode PAY_SIGN_EXTENSION_NOT_FOUND = new ErrorCode(1_007_003_000, "支付交易拓展单不存在");
    ErrorCode PAY_SIGN_EXTENSION_STATUS_IS_NOT_WAITING = new ErrorCode(1_007_003_001, "支付交易拓展单不处于待支付");
