...
public class PaySignExcelVO {
    ...
    @ExcelProperty(value = "首次支付金额", converter = MoneyConvert.class)
    private Integer firstPrice;
    @ExcelProperty(value = "后续支付金额", converter = MoneyConvert.class)
    ...
    @DictFormat(DictTypeConstants.SIGN_STATUS)
