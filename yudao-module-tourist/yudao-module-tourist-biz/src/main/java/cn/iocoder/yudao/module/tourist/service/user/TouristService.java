...
public interface TouristService {
     ...
     * @return 用户对象
     */
    TouristDO getUserByMobile(String mobile);
     ...
     * @return 用户信息的列表
     */
    List<TouristDO> getUserListByNickname(String nickname);
     ...
     * @return 用户对象
     */
    TouristDO createUserIfAbsent(@Mobile String mobile, String registerIp);
     ...
     * @return 用户对象信息数组
     */
    List<TouristDO> getUserList(Collection<Long> ids);
